...
public partial class MainViewModel : ViewModelBase
{
    ...
    [
        ...
        new("输入", Icons.Bulletpoint, false,
        [
    ...
    [RelayCommand]
    private void OpenCatalogItem(CatalogItemViewModel? item)
    {
        if (item is null)
        {
            return;
...
public partial class CatalogSectionViewModel : ObservableObject
{
    public CatalogSectionViewModel(string title, Geometry iconData, bool isExpanded, IReadOnlyList<CatalogItemViewModel> children)
    {
        Title = title;
        IconData = iconData;
