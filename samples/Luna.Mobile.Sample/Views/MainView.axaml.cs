...
public partial class MainView : UserControl
{
    ...
    private static Control? CreateSampleView(string path)
    {
        return path switch
        {
            ...
            "/segmented" => new SegmentedDemoView(),
            "/skeleton" => new SkeletonDemoView(),
            "/slider" => new SliderDemoView(),
            "/steps" => new StepsDemoView(),
            "/stepper" => new StepperDemoView(),
            "/switch" => new SwitchDemoView(),
            "/swipecell" => new SwipeCellDemoView(),
            "/tag" => new TagDemoView(),
            "/toast" => new ToastDemoView(),
            "/watermark" => new WatermarkDemoView(),
            _ => null,
        };
    }
}
